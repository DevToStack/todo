...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            <form
                onSubmit={submit}
                className="relative bg-neutral-900/50 backdrop-blur-xl p-8 rounded-2xl w-full max-w-md space-y-6 border border-neutral-800 shadow-2xl"
            >
                {/* Header */}
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative group">
                        <HiUser className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500 group-focus-within:text-blue-500 transition-colors" />
                        <input
                ...
                <div className="flex items-center">
                    ...
                    <label htmlFor="terms" className="ml-2 text-sm text-neutral-400">
                        I agree to the{' '}
                        <a href="/terms" className="text-blue-500 hover:text-blue-400 transition-colors">
                            Terms of Service
                        </a>{' '}
                        and{' '}
                        <a href="/privacy" className="text-blue-500 hover:text-blue-400 transition-colors">
                            Privacy Policy
                        </a>
                    </label>
                </div>
